...
#print(pairwiseResultMatrix)
constructDistMatrix(pairwiseResultMatrix)
#print(pairwiseDistanceMatrix)
#print(pairwiseResultMatrix[0][0+1][1])

for element in pairwiseDistanceMatrix:
    print(element)


#y = pdist(pairwiseDistanceMatrix)
y = spatial.distance.squareform(pairwiseDistanceMatrix)
#print(y)
Z = average(y)
print(Z)

print(fcluster(Z, 0.791925 , criterion='distance'))
...
labels = ['ID_0','ID_1','ID_2','ID_3','ID_5','ID_6','ID_7','ID_8']
...
output=extract_levels(row_clusters,labels)
