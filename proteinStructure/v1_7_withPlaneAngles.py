...
def insertEncodedNames(data):
    ...
    for element in data:
        ...
        for point in range(0,len(element)):
            ...
            d_4 = [0, 0, 0]  # vpython.vector(0,0,0)
            ...
            d_2 = np.array([float(element[point + 4][3]), float(element[point + 4][4]), float(element[point + 4][5])])
            #except:
            #    continue
            j = -1
            for element_2 in data:
                ...
                for point_2 in range(0, len(element_2)):
                    ...
                    d_distance = math.sqrt(math.pow(d_2[0] - a_3[0], 2) + math.pow(d_2[1] - a_3[1], 2) + math.pow(d_2[1] - a_3[1], 2))
                    #except:
                    #    continue
            ...
            encodedAaNames[i].append([aadict.get(a),aadict.get(b),aadict.get(c),aadict.get(d),round(a_4[0],2),round(a_4[1],2),round(a_4[2],2),
            round(b_4[0],2),round(b_4[1],2),round(b_4[2],2),round(c_4[0],2),round(c_4[1],2),round(c_4[2],2),round(d_4[0],2),round(d_4[1],2),round(d_4[2],2)])
...
def writeToFile(encodedAaNames):
    f_2 = open("text.txt","w")
    text = ""
